...
/* ------------------------- Function Declarations ------------------------- */
  ...
  /* -------------------- Turn 4 -------------------- */
      if(turnCount === 4) {
      /* ----- CPU Center Tile Defense ----- */
        if($("#center-mid").children().html() === playerOneSymbol) {
          cpuDefense();
        }
